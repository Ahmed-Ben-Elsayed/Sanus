    ...
    return (
        <>
            ...
            <div className="shadow-sm rounded-xl w-full bg-white h-[calc(100vh-77px)] p-4 flex flex-col">
                ...
                {modal ?
                    <Modal onClose={() => setModal(false)} onConfirm={() => deletePkg(packageId)} cancelText='No' open={modal} showActions children={"Are You Sure Delete This Packege"} />
                    : ""
                }
            </div>
        </>
