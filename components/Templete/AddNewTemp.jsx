...
const AddNewTemp = () => {
    ...
    const saveTemplate = async () => {
        if (!Temp.Name || !Temp.nameAr || !Temp.startDate) {
            toast.warning("Template name, name in Arabic, and start date are required ⚠️");
            return;
        }
        ...
        <div className="shadow-sm rounded-xl overflow-auto w-full bg-white md:h-[calc(100vh-77px)] p-3 md:p-4 flex flex-col">
            ...
            <div className="inputs grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-3 mb-6">
                <div className="xl:col-span-1 lg:col-span-1 sm:col-span-1">
                    ...
                    <ReusableInput
                        label="Template Name (Ar)"
                        value={Temp.nameAr}
                        onChange={(e) => handleInputChange("nameAr", e.target.value)}
                        placeholder="Add Template Name in Arabic"
                    />
